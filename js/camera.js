...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		height				: '42.43%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
		...
		minHeight			: '515px',	//you can also leave it blank		
